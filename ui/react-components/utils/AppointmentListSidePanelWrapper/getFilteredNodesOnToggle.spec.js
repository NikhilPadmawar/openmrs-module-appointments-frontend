...
import GetFilteredNodesOnToggle from "./GetFilteredNodesOnToggle";
...
describe("Search node with given search text", () => {
  const data = [
    {
      ...
      children: [
        {
          title: "New patients [30 min]",
          key: "173dd652-5ca7-4cfc-80d1-d417b81ebdbb",
          duration: 30,
          name: "New patients",
          uuid: "173dd652-5ca7-4cfc-80d1-d417b81ebdbb",
        },
        {
          title: "Follow-up [20 min]",
          key: "4aa8a49f-1eb2-4971-8730-794ec093f3e3",
          duration: 20,
          name: "Follow-up",
          uuid: "4aa8a49f-1eb2-4971-8730-794ec093f3e3",
        },
  ...
  it("Should return length 0", () => {
    const filteredData = GetFilteredNodesOnToggle(data, []);
    expect(filteredData.length).toBe(0);
  });
  it("Should return length 1", () => {
    const filteredData = GetFilteredNodesOnToggle(data, [
      "4aa8a49f-1eb2-4971-8730-794ec093f3e3",
    ]);
